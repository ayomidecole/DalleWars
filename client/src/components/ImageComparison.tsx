    ...
    return (
      <div className="flex justify-center my-8">
        <Card className="w-full max-w-2xl bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 transition-colors duration-200 dark:card-glow">
          <CardHeader>
            <CardTitle className="text-gray-800 dark:text-gray-200 transition-colors dark:heading-glow">No Images Yet</CardTitle>
    ...
    <section id="imagesComparison" className="my-8">
      <div className="mb-10">
        <div className="max-w-4xl mx-auto">
          <div className="p-4 mb-5 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200 dark:card-glow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* DALL-E 2 Image Card */}
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg shadow-md dark:shadow-none overflow-hidden transition-all duration-200 dark:card-glow">
              <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center bg-white dark:bg-gray-800/50 transition-colors">
                <h4 className="font-bold text-gray-800 dark:text-gray-200 text-lg transition-colors dark:heading-glow">DALL·E 2</h4>
              ...
              <div className="p-4">
                <div className="image-card relative overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm max-w-xs mx-auto aspect-[4/3] transition-all hover:scale-[1.02] cursor-pointer">
                  <img 
              ...
              <div className="px-4 pb-4 pt-2 flex justify-center">
                <Button 
                  ...
                  className={votedPairs[pair.id] === "dalle2" 
                    ? "bg-gray-800 text-white hover:bg-gray-700 w-full py-2 text-sm dark:bg-gray-700 dark:hover:bg-gray-600 transition-colors dark:shadow-[0_0_10px_rgba(255,255,255,0.2)]" 
                    : "border-2 border-gray-800 text-gray-800 font-medium hover:bg-gray-800 hover:text-white w-full py-2 text-sm dark:border-gray-500 dark:text-gray-300 dark:hover:bg-gray-700 transition-colors group-hover:dark:shadow-[0_0_15px_rgba(255,255,255,0.25)]"}
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg shadow-md dark:shadow-none overflow-hidden transition-all duration-200 dark:card-glow">
              <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-white dark:bg-green-950/30 transition-colors">
                <h4 className="font-bold text-gray-800 dark:text-gray-200 text-lg transition-colors dark:heading-glow dark:text-green-100" style={{animation: "softGlow 3s infinite ease-in-out"}}>DALL·E 3</h4>
              ...
              <div className="px-4 pb-4 pt-2 flex justify-center">
                <Button 
                  ...
                  className={votedPairs[pair.id] === "dalle3" 
                    ? "bg-primary text-white hover:bg-primary/90 w-full py-2 text-sm dark:btn-primary transition-colors dark:shadow-[0_0_15px_rgba(16,163,127,0.3)]" 
                    : "border-2 border-primary text-primary font-medium hover:bg-primary hover:text-white w-full py-2 text-sm dark:border-primary/80 dark:text-primary/90 dark:hover:bg-primary/80 transition-colors group-hover:dark:shadow-[0_0_18px_rgba(16,163,127,0.35)]"}
